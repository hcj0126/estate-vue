<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="所属成员" prop="ownerId">
        <el-input
    ...
    <el-table v-loading="loading" :data="carList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属成员" align="center" prop="ownerId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属成员" prop="ownerId">
          <el-input v-model="form.ownerId" placeholder="请输入所属成员" />
        </el-form-item>
        <el-form-item label="车辆颜色" prop="carColor">
...
<script>
import { listCar, getCar, delCar, addCar, updateCar } from "@/api/estate/car";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('estate/car/export', {
        ...this.queryParams
